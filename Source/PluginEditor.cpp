    ...
    : AudioProcessorEditor (&p), processor (p)
{
	...
	//amplitude.setRange(0.0, 0.5, 0.05);
...
void SineConvolutionAudioProcessorEditor::paint (Graphics& g)
{
	...
	g.drawFittedText("Frequency", 0, 0, getWidth(), 30, Justification::centred, 1);
}
...
void SineConvolutionAudioProcessorEditor::sliderValueChanged(Slider *slider) {
	processor.mFrequency = frequency.getValue();
	//processor.mLevel = amplitude.getValue();
}
